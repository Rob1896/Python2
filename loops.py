...
for super in supermarket:
    print('la lista del super: ', super) # en este caso imprime la variable "super"
...
precios = {'arroz':1230, 'frijoles':1100, 'leche':800, 'azucar':1300}
for things, prices in precios.items():
    print(things, prices)
...
# usando continue
# continue lo que hace es saltar la iteration
for i in range(1,10):
    if i == 4: # aqui le digo que si la iteration es igual a 4 que la salte
        continue
    print(i) # va a imprimir todos los # del 1 al 10 menos el 4
...
for i in "python":
    if i == 't':
        continue
    print("viendo la letra: ", i) # va a imprimir todos las letras menos la T
...
while i < 10:
    i += 1
    if i == 4:
        break # la diferencia del break es que el break finaliza todo el while, el continue omite la condicion 
    print('favorites numbers are: ',i)
