...
# es la misma funcion pero se incorpora return
def saludo(nombre):
    text= nombre + ' Welcome!'
    return text  # el retur me devuelve el resultado de la funcion

print(saludo('Alyssa')) # el return le da el resultado a este print


# ejemplo 2 sin return
def resta(num1, num2):
    resultado = num1-num2
    print(resultado)
...
# mismo ejemplo con return
def resta(num1, num2):
    resultado = num1-num2
    return resultado
   
print('el resultado es: ',resta(10,4))
print(resta(10,6))
